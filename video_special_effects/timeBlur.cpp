/*
  ...
  Running the blur5x5_1 and blur5x5_2 functions on an image and timing them.
*/
...
int main(int argc, char *argv[]) {  // main function, execution starts here
  ...
  // print the results
  printf("Time per image (1): %.9lf seconds\n", difference );
  ...
  // print the results
  printf("Time per image (2): %.9lf seconds\n", difference );
